...
class User(People):
    ...
    referee = db.relationship('Referal',
                              foreign_keys=[Referal.referenced_id],
                              backref=db.backref('referenced', lazy='joined'),
                              lazy='dynamic',
                              cascade='all, delete-orphan')

    referenced = db.relationship('Referal',
                                 foreign_keys=[Referal.referee_id],
...
class Project(db.Model):
    ...
    volunteer = db.relationship('Volunteer',
                                secondary=volPro,
                                backref=db.backref('project',lazy='dynamic'), lazy='dynamic')
    ...
    comments = db.relationship('Comment',
                               backref='project',
                               lazy='dynamic')
    photos = db.relationship('ProjectPhoto',
                             backref='project',
                             lazy='dynamic')
    solutionphotos = db.relationship('SolutionPhotos',
                                     backref='project',
                                     lazy='dynamic')
